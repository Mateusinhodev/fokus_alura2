...
const btnDeletarCheck = document.querySelector('#btn-remover-concluidas')
const btnDeletarAll = document.querySelector('#btn-remover-todas')
...
btnDeletarCheck.addEventListener('click', () => {
    removerTarefas(true)
});
btnDeletarAll.addEventListener('click', () => {
